...
-- Généré le :  Mer 16 Février 2022 à 15:38
...
INSERT INTO `UTILISATEUR` (`idUser`, `nom`, `prenom`, `mdp`, `mail`) VALUES
(1, 'Choquet', 'Chloé', 'CC0001', 'chloe.choquet@etu.univ-grenoble-alpes.fr'),
(2, 'Albasini', 'Fiorella', 'FA0001', 'fiorella.albasini@etu.univ-grenoble-alpes.fr');
